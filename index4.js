...
app.post('/register', async (req, res) => {
    ...
    // Sobrescrevendo os valores para aplicar a formatação desejada
    ...
    try {
        ...
        if (existingRowIndex !== -1) {
            ...
            const range = `Página1!B${existingRowIndex + 1}:G${existingRowIndex + 1}`;
            ...
            const range = 'Página1!A:G';// Adicionar uma nova linha
            const values = [
